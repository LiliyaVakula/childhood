    ...
    <footer>
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <a href="<?php the_field('privacy_policy', 2); ?>" class="footer__policy"><?php the_field('privacy_policy', 2); ?></a>
          </div>
        </div>
      </div>
    </footer>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAaSxXLhWYGdQZGEPplHe_hCFh24dj7q9Q"></script>
